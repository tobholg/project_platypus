//! world generation, resources & helpers
//!
//! All procedural‑generation code plus the shared data structures
//! that represent the world live here.  Run‑time streaming and
//! digging logic has been moved to `tile_stream.rs`.
//!

...
| G1 | Gear: stats from what's worn and held, armour and resistances on every hurt, equipment slots and panel, cloth/leather/iron sets and trinkets; gear drawn on every humanoid (skins: recolours + overlays) and icons from it; rarity (common → legendary) and rolled, named bonuses by item level, found in chests; bodies to loot (what the dead wore and carried + their loot table), chests and bodies both containers (branch `gear-arc`, DESIGN §7c) | in progress |

...
| G1 | Gear: stats from what's worn and held, armour and resistances on every hurt, equipment slots and panel, cloth/leather/iron sets and trinkets; gear drawn on every humanoid (skins: recolours + overlays) and icons from it (branch `gear-arc`, DESIGN §7c) | in progress |
